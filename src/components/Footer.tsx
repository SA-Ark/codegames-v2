    ...
    <footer className="relative py-20 px-6 border-t border-white/[0.03] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-4 gap-10 mb-14">
          ...
          <div>
            <h4 className="font-semibold text-sm mb-5 text-gray-400 uppercase tracking-[0.15em]">Courses</h4>
          ...
          <div>
            <h4 className="font-semibold text-sm mb-5 text-gray-400 uppercase tracking-[0.15em]">Company</h4>
            <ul className="space-y-3 text-sm text-gray-600">
        ...
        <div className="pt-8 border-t border-white/[0.03] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a href="mailto:hello@codegames.tech" className="text-gray-600 hover:text-white transition-colors text-sm">
